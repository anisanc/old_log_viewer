function varargout = logging(varargin)
% Last Modified by GUIDE v2.5 13-Feb-2016 15:49:35
% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @logging_OpeningFcn, ...
                   'gui_OutputFcn',  @logging_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before logging is made visible.
function logging_OpeningFcn(hObject, eventdata, handles, varargin)
%==========================================================================
...
[~,~,handles.data1.formation]=xlsread('F:\01 My Documents\01 Thesis\Matlab\data 15_5_7a.xlsx');
[~,~,handles.data2.formation]=xlsread('F:\01 My Documents\01 Thesis\Matlab\data 15_6_9s.xlsx');
[~,~,handles.data3.formation]=xlsread('F:\01 My Documents\01 Thesis\Matlab\data 15_6_11s.xlsx');
[~,~,handles.data4.formation]=xlsread('F:\01 My Documents\01 Thesis\Matlab\data 15_6_12.xlsx');

[~,~,handles.data1.casing]=xlsread('F:\01 My Documents\01 Thesis\Data\Casing\15_5_7a.xlsx');
[~,~,handles.data2.casing]=xlsread('F:\01 My Documents\01 Thesis\Data\Casing\15_6_9s.xlsx');
[~,~,handles.data3.casing]=xlsread('F:\01 My Documents\01 Thesis\Data\Casing\15_6_11s.xlsx');
[~,~,handles.data4.casing]=xlsread('F:\01 My Documents\01 Thesis\Data\Casing\15_6_12.xlsx');
...
function varargout = logging_OutputFcn(hObject, eventdata, handles) 
